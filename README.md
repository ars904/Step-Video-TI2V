...
<table border="0" style="width: 30%; text-align: center; margin-top: 0.5px;">
  <tr>
    <th style="width: 100%;">女人眨眼，然后对着镜头做飞吻的动作</th>
    <th style="width: 100%;">女生向前行走，背景是虚化模糊的效果</th>
    <th style="width: 100%;">狸猫战士双手缓缓上扬，雷电从手中向四周扩散，身后灵兽影像的双眼闪烁强光，张开巨口发出低吼</th>
  </tr>
  <tr>
    <td><video src="https://github.com/user-attachments/assets/67038b85-19d4-4313-b386-f578b75dcad7" height="100%" controls autoplay loop muted></video></td>
    <td><video src="https://github.com/user-attachments/assets/80be13a1-ea65-45c5-b7f4-c2488acbf2a3" height="100%" controls autoplay loop muted></video></td>
    <td><video src="https://github.com/user-attachments/assets/73ffd269-a5c8-4255-8809-161501273bfd" height="100%" controls autoplay loop muted></video></td>
  </tr>
</table>
